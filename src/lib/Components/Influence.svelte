<div class="flex flex-col items-center space-y-15 py-15" id="influence">
	<div class="flex flex-col space-y-5 items-center">
		<h1 class="text-4xl text-neutral-900 text-center px-2">
			Vplyv na slovenskú kultúru a národné hnutie
		</h1>
